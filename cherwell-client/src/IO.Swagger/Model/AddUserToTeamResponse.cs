...
namespace IO.Swagger.Model
{
    ...
    public partial class AddUserToTeamResponse :  IEquatable<AddUserToTeamResponse>, IValidatableObject
    {
        ...
        public AddUserToTeamResponse(string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddUserToTeamResponse {\n");
        ...
        {
            return this.Equals(input as AddUserToTeamResponse);
        }

        /// <summary>
        /// Returns true if AddUserToTeamResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AddUserToTeamResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddUserToTeamResponse input)
        {
            if (input == null)
                return false;
