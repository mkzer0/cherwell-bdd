...
namespace IO.Swagger.Model
{
    ...
    public partial class SimpleResultsList :  IEquatable<SimpleResultsList>, IValidatableObject
    {
        ...
        public SimpleResultsList(List<SimpleResultsListGroup> Groups = default(List<SimpleResultsListGroup>), string Title = default(string))
        {
            this.Groups = Groups;
            this.Title = Title;
        }
        ...
        {
            return this.Equals(input as SimpleResultsList);
        }
