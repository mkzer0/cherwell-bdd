...
namespace IO.Swagger.Model
{
    ...
    public partial class DeleteApiClientSettingsResponse :  IEquatable<DeleteApiClientSettingsResponse>, IValidatableObject
    {
        ...
        public DeleteApiClientSettingsResponse(string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteApiClientSettingsResponse {\n");
        ...
        {
            return this.Equals(input as DeleteApiClientSettingsResponse);
        }

        /// <summary>
        /// Returns true if DeleteApiClientSettingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteApiClientSettingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteApiClientSettingsResponse input)
        {
            if (input == null)
                return false;
