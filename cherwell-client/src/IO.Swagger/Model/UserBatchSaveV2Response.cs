...
namespace IO.Swagger.Model
{
    ...
    public partial class UserBatchSaveV2Response :  IEquatable<UserBatchSaveV2Response>, IValidatableObject
    {
        ...
        public UserBatchSaveV2Response(List<UserSaveV2Response> Responses = default(List<UserSaveV2Response>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        {
            return this.Equals(input as UserBatchSaveV2Response);
        }
