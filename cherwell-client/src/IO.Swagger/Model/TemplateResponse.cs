...
namespace IO.Swagger.Model
{
    ...
    public partial class TemplateResponse :  IEquatable<TemplateResponse>, IValidatableObject
    {
        ...
        public TemplateResponse(List<FieldTemplateItem> Fields = default(List<FieldTemplateItem>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
            this.Fields = Fields;
