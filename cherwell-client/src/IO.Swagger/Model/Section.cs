...
namespace IO.Swagger.Model
{
    ...
    public partial class Section :  IEquatable<Section>, IValidatableObject
    {
        ...
        public Section(List<SectionField> SectionFields = default(List<SectionField>), string GalleryImage = default(string), string Title = default(string), string RelationshipId = default(string), string TargetBusObId = default(string), string TargetBusObRecId = default(string))
        {
