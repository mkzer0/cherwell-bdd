...
namespace IO.Swagger.Model
{
    ...
    public partial class AddUserToTeamByBatchResponse :  IEquatable<AddUserToTeamByBatchResponse>, IValidatableObject
    {
        ...
        public AddUserToTeamByBatchResponse(List<AddUserToTeamResponse> Responses = default(List<AddUserToTeamResponse>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddUserToTeamByBatchResponse {\n");
        ...
        {
            return this.Equals(input as AddUserToTeamByBatchResponse);
        }

        /// <summary>
        /// Returns true if AddUserToTeamByBatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AddUserToTeamByBatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddUserToTeamByBatchResponse input)
        {
            if (input == null)
                return false;
