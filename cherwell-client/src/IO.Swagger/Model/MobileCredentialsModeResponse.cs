...
namespace IO.Swagger.Model
{
    ...
    public partial class MobileCredentialsModeResponse :  IEquatable<MobileCredentialsModeResponse>, IValidatableObject
    {
        ...
        public MobileCredentialsModeResponse(int? CredentialsMode = default(int?), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MobileCredentialsModeResponse {\n");
        ...
        {
            return this.Equals(input as MobileCredentialsModeResponse);
        }

        /// <summary>
        /// Returns true if MobileCredentialsModeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MobileCredentialsModeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MobileCredentialsModeResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CredentialsMode == input.CredentialsMode ||
                    (this.CredentialsMode != null &&
                    this.CredentialsMode.Equals(input.CredentialsMode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CredentialsMode != null)
                    hashCode = hashCode * 59 + this.CredentialsMode.GetHashCode();
