...
namespace IO.Swagger.Model
{
    ...
    public partial class BatchSaveResponse :  IEquatable<BatchSaveResponse>, IValidatableObject
    {
        ...
        public BatchSaveResponse(List<SaveResponse> Responses = default(List<SaveResponse>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchSaveResponse {\n");
        ...
        {
            return this.Equals(input as BatchSaveResponse);
        }

        /// <summary>
        /// Returns true if BatchSaveResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchSaveResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchSaveResponse input)
        {
            if (input == null)
                return false;
