...
namespace IO.Swagger.Model
{
    ...
    public partial class UserBatchDeleteRequest :  IEquatable<UserBatchDeleteRequest>, IValidatableObject
    {
        ...
        public UserBatchDeleteRequest(bool? StopOnError = default(bool?), List<string> UserRecordIds = default(List<string>))
        {
        ...
        {
            return this.Equals(input as UserBatchDeleteRequest);
        }
