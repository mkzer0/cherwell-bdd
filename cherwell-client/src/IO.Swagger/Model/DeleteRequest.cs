...
namespace IO.Swagger.Model
{
    ...
    public partial class DeleteRequest :  IEquatable<DeleteRequest>, IValidatableObject
    {
        ...
        public DeleteRequest(string BusObId = default(string), string BusObPublicId = default(string), string BusObRecId = default(string))
        {
        ...
        {
            return this.Equals(input as DeleteRequest);
        }

        /// <summary>
        /// Returns true if DeleteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteRequest input)
        {
            if (input == null)
                return false;
