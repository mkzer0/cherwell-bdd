...
namespace IO.Swagger.Model
{
    ...
    public partial class UserDeleteV2Response :  IEquatable<UserDeleteV2Response>, IValidatableObject
    {
        ...
        public UserDeleteV2Response(string UserRecordId = default(string), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        {
            return this.Equals(input as UserDeleteV2Response);
        }

        /// <summary>
        /// Returns true if UserDeleteV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UserDeleteV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserDeleteV2Response input)
        {
            if (input == null)
                return false;
