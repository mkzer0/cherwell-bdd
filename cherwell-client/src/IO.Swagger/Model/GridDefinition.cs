...
namespace IO.Swagger.Model
{
    ...
    public partial class GridDefinition :  IEquatable<GridDefinition>, IValidatableObject
    {
        ...
        public GridDefinition(string GridId = default(string), string Name = default(string), string DisplayName = default(string))
        {
            this.GridId = GridId;
            this.Name = Name;
        ...
        {
            return this.Equals(input as GridDefinition);
        }
