...
namespace IO.Swagger.Model
{
    ...
    public partial class GetSecurityGroupBusinessObjectPermissionsResponse :  IEquatable<GetSecurityGroupBusinessObjectPermissionsResponse>, IValidatableObject
    {
        ...
        public GetSecurityGroupBusinessObjectPermissionsResponse(List<BusinessObjectPermission> BusinessObjectPermissions = default(List<BusinessObjectPermission>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSecurityGroupBusinessObjectPermissionsResponse {\n");
        ...
        {
            return this.Equals(input as GetSecurityGroupBusinessObjectPermissionsResponse);
        }

        /// <summary>
        /// Returns true if GetSecurityGroupBusinessObjectPermissionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSecurityGroupBusinessObjectPermissionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSecurityGroupBusinessObjectPermissionsResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.BusinessObjectPermissions == input.BusinessObjectPermissions ||
                    this.BusinessObjectPermissions != null &&
                    this.BusinessObjectPermissions.SequenceEqual(input.BusinessObjectPermissions)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BusinessObjectPermissions != null)
                    hashCode = hashCode * 59 + this.BusinessObjectPermissions.GetHashCode();
