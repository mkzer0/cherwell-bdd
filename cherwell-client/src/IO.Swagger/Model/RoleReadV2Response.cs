...
namespace IO.Swagger.Model
{
    ...
    public partial class RoleReadV2Response :  IEquatable<RoleReadV2Response>, IValidatableObject
    {
        ...
        public RoleReadV2Response(List<Role> Roles = default(List<Role>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
            this.Roles = Roles;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoleReadV2Response {\n");
        ...
        {
            return this.Equals(input as RoleReadV2Response);
        }

        /// <summary>
        /// Returns true if RoleReadV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleReadV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleReadV2Response input)
        {
            if (input == null)
                return false;
