...
namespace IO.Swagger.Model
{
    ...
    public partial class UserBatchSaveRequest :  IEquatable<UserBatchSaveRequest>, IValidatableObject
    {
        ...
        public UserBatchSaveRequest(List<UserSaveRequest> SaveRequests = default(List<UserSaveRequest>), bool? StopOnError = default(bool?))
        {
        ...
        {
            return this.Equals(input as UserBatchSaveRequest);
        }
