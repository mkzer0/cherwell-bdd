...
namespace IO.Swagger.Model
{
    ...
    public partial class UserDeleteResponse :  IEquatable<UserDeleteResponse>, IValidatableObject
    {
        ...
        public UserDeleteResponse(string Error = default(string), string ErrorCode = default(string), bool? HasError = default(bool?), List<User> Users = default(List<User>))
        {
            this.Error = Error;
        ...
        {
            return this.Equals(input as UserDeleteResponse);
        }
