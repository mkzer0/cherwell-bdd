...
namespace IO.Swagger.Model
{
    ...
    public partial class UserV2 :  IEquatable<UserV2>, IValidatableObject
    {
        ...
        public UserV2(bool? AccountLocked = default(bool?), DateTime? CreateDateTime = default(DateTime?), string DisplayName = default(string), List<FieldTemplateItem> Fields = default(List<FieldTemplateItem>), DateTime? LastPasswordResetDate = default(DateTime?), DateTime? LastResetDateTime = default(DateTime?), bool? LdapRequired = default(bool?), bool? PasswordNeverExpires = default(bool?), string PublicId = default(string), string RecordId = default(string), string SecurityGroupId = default(string), string ShortDisplayName = default(string), bool? UserCannotChangePassword = default(bool?), bool? UserMustResetPasswordAtNextLogin = default(bool?), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        {
            return this.Equals(input as UserV2);
        }
