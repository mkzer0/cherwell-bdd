...
namespace IO.Swagger.Model
{
    ...
    public partial class TeamsV2Response :  IEquatable<TeamsV2Response>, IValidatableObject
    {
        ...
        public TeamsV2Response(List<Team> Teams = default(List<Team>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
            this.Teams = Teams;
        ...
        {
            return this.Equals(input as TeamsV2Response);
        }
