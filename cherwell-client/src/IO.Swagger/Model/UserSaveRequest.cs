...
namespace IO.Swagger.Model
{
    ...
    public partial class UserSaveRequest :  IEquatable<UserSaveRequest>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UserSaveRequest);
        }
