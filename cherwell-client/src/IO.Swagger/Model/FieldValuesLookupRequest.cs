...
namespace IO.Swagger.Model
{
    ...
    public partial class FieldValuesLookupRequest :  IEquatable<FieldValuesLookupRequest>, IValidatableObject
    {
        ...
        public FieldValuesLookupRequest(string BusbPublicId = default(string), string BusObId = default(string), string BusObRecId = default(string), string FieldId = default(string), string FieldName = default(string), List<FieldTemplateItem> Fields = default(List<FieldTemplateItem>))
        {
        ...
        {
            return this.Equals(input as FieldValuesLookupRequest);
        }
