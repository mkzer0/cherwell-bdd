...
namespace IO.Swagger.Model
{
    ...
    public partial class DeleteResponse :  IEquatable<DeleteResponse>, IValidatableObject
    {
        ...
        public DeleteResponse(string BusObId = default(string), string BusObPublicId = default(string), string BusObRecId = default(string), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
