...
namespace IO.Swagger.Model
{
    ...
    public partial class QuickSearchConfigSavedRequest :  IEquatable<QuickSearchConfigSavedRequest>, IValidatableObject
    {
        ...
        public QuickSearchConfigSavedRequest(string StandIn = default(string), List<string> BusObIds = default(List<string>), bool? IsGeneral = default(bool?))
        {
        ...
        {
            return this.Equals(input as QuickSearchConfigSavedRequest);
        }
