...
namespace IO.Swagger.Model
{
    ...
    public partial class RemoveUserFromTeamResponse :  IEquatable<RemoveUserFromTeamResponse>, IValidatableObject
    {
        ...
        public RemoveUserFromTeamResponse(string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        {
            return this.Equals(input as RemoveUserFromTeamResponse);
        }
