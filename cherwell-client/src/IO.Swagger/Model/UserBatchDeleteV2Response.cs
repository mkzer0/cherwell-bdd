...
namespace IO.Swagger.Model
{
    ...
    public partial class UserBatchDeleteV2Response :  IEquatable<UserBatchDeleteV2Response>, IValidatableObject
    {
        ...
        public UserBatchDeleteV2Response(List<UserDeleteV2Response> Responses = default(List<UserDeleteV2Response>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        {
            return this.Equals(input as UserBatchDeleteV2Response);
        }
