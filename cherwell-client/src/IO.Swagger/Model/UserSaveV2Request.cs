...
namespace IO.Swagger.Model
{
    ...
    public partial class UserSaveV2Request :  IEquatable<UserSaveV2Request>, IValidatableObject
    {
        ...
        public UserSaveV2Request(bool? AccountLocked = default(bool?), string BusObId = default(string), string BusObPublicId = default(string), string BusObRecId = default(string), string DisplayName = default(string), bool? LdapRequired = default(bool?), string LoginId = default(string), DateTime? NextPasswordResetDate = default(DateTime?), string Password = default(string), bool? PasswordNeverExpires = default(bool?), string SecurityGroupId = default(string), bool? UserCannotChangePassword = default(bool?), List<FieldTemplateItem> UserInfoFields = default(List<FieldTemplateItem>), bool? UserMustChangePasswordAtNextLogin = default(bool?), string WindowsUserId = default(string))
        {
        ...
        {
            return this.Equals(input as UserSaveV2Request);
        }
