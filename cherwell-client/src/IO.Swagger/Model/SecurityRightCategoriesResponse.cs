...
namespace IO.Swagger.Model
{
    ...
    public partial class SecurityRightCategoriesResponse :  IEquatable<SecurityRightCategoriesResponse>, IValidatableObject
    {
        ...
        public SecurityRightCategoriesResponse(List<RightCategory> RightCategories = default(List<RightCategory>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?))
        {
        ...
        {
            return this.Equals(input as SecurityRightCategoriesResponse);
        }
        ...
        public bool Equals(SecurityRightCategoriesResponse input)
        {
            ...
            return 
                (
                    this.RightCategories == input.RightCategories ||
                    this.RightCategories != null &&
                    this.RightCategories.SequenceEqual(input.RightCategories)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RightCategories != null)
                    hashCode = hashCode * 59 + this.RightCategories.GetHashCode();
